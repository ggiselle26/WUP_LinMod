...
CORRELATION MATRIX SHOWS THAT SIMS CORRELATES WITH GRIP AND ARM ALSO THAT GRIP AND sims 
### descriptive results - scatterplot
...
```
 ...
 p-value from the model parameters: intercept, coefficient of arm and cofficient of grip 
...
model 1 sims~arm is better then model 2 sims~grip
